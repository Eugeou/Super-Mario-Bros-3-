...
void CMario::OnCollisionWith(LPCOLLISIONEVENT e)
{
	...
	else if (dynamic_cast<CBluePButton*>(e->obj))
		OnCollisionWithBluePButton(e);
}
void CMario::OnCollisionWithBluePButton(LPCOLLISIONEVENT e) {
	CBluePButton* button = dynamic_cast<CBluePButton*>(e->obj);
...
void CMario::OnCollisionWithFireBall(LPCOLLISIONEVENT e) {
	if (untouchable) return;
	CFireBall* bullet = dynamic_cast<CFireBall*>(e->obj);
