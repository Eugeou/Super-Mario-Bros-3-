...
#define ID_SPRITE_VENUSPLANT_HEAD_UP_LEFT (ID_SPRITE_VENUSPLANT+1000)
#define ID_SPRITE_VENUSPLANT_HEAD_DOWN_LEFT (ID_SPRITE_VENUSPLANT+2000)
#define ID_SPRITE_VENUSPLANT_HEAD_UP_RIGHT (ID_SPRITE_VENUSPLANT+3000)
#define ID_SPRITE_VENUSPLANT_HEAD_DOWN_RIGHT (ID_SPRITE_VENUSPLANT+4000)
